...
export const Auth = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col min-h-screen text-gray-600 font-mono">
        ...
        <form id="appform" onSubmit={submitAuthHandler}>
                <div>
                        <input className="mb-3 px-3 text-sm py-2 border border-gray-300"
                                name="email"
                                type="email"
                                autoFocus
                ...
                <div className="flex justify-center my-2">
                        <button 
                                className="disable:opacity-40 py-2 px-4 rounded text-white bg-indigo-600"
                                disabled={!email || !pw}
                                type="submit"
                                form="appform"
                                >
